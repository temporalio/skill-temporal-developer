...
| OpenTelemetry (`temporalio[opentelemetry]`) | Python | Distributed tracing via the `OpenTelemetryPlugin` (experimental); propagates W3C TraceContext + Baggage across Client, Workflow, Activity (including Standalone), Child Workflow, and Nexus boundaries | `references/python/integrations/opentelemetry.md` | `references/python/observability.md`, `references/python/standalone-activities.md` |
