...
| Spring AI (`temporal-spring-ai`) | Java | Runs Spring AI chat-model calls, tools, vector stores, embeddings, and MCP clients durably through Temporal Activities | `references/java/integrations/spring-ai.md` | `references/java/integrations/spring-boot.md`, `references/core/ai-patterns.md` |
