...
| Protobuf.js (v8 migration) | TypeScript | Configure protobuf payload conversion in TypeScript; enable proto3‑JSON or binary via protobuf-aware converters; migration notes for protobufjs v8 | `references/typescript/integrations/protobufjs.md` | `references/typescript/typescript.md` |
