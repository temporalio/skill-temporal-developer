...
| OpenAI Agents Sandbox (`temporalio.contrib.openai_agents`) | Python | Pre-release. Routes OpenAI Agents SDK `SandboxAgent` session lifecycle and I/O (exec, file r/w, PTY) through Temporal activities | `references/python/integrations/openai-agents-sandbox.md` | `references/python/ai-patterns.md`, `references/python/determinism-protection.md` |
