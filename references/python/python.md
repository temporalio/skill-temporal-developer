...
- **`references/python/patch-activation-callback.md`** - Control first non-replay `workflow.patched()` activation; concept at `references/core/patch-activation-callback.md`.
