...
- **`references/python/workflow-streams.md`** - Public-preview `temporalio.contrib.workflow_streams` library: durable offset-addressed event channel for streaming Workflow progress to outside subscribers (UIs, SSE proxies, terminal clients)
