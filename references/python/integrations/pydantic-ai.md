...
This integration comes from Pydantic AI, not `temporalio.contrib`. For general design guidance, also read [references/core/ai-patterns.md](../../core/ai-patterns.md) and [references/python/ai-patterns.md](../ai-patterns.md).
...
- [references/python/ai-patterns.md](../ai-patterns.md) — Python AI/LLM patterns, payload conversion, and retry classification.
- [references/core/ai-patterns.md](../../core/ai-patterns.md) — language-agnostic agent and tool-placement patterns.
