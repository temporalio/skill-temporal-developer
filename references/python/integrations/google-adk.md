...
For general Temporal AI/LLM patterns (retries, rate limits, multi-agent orchestration) see [references/core/ai-patterns.md](../../core/ai-patterns.md) and [references/python/ai-patterns.md](../ai-patterns.md).
