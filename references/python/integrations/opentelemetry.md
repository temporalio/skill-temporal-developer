...
For observability beyond OpenTelemetry tracing (metrics, logging, Search Attributes) read [references/python/observability.md](../observability.md).
...
- SDK metrics and observability reference: [references/python/observability.md](../observability.md)
