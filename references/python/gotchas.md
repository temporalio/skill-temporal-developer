...
Python-specific mistakes and anti-patterns. See also [Common Gotchas](../core/gotchas.md) for language-agnostic concepts.
...
[references/python/determinism-protection.md](determinism-protection.md) contains more info about the Python sandbox.
...
The Temporal Python SDK supports both async and sync activities. See [references/python/sync-vs-async.md](sync-vs-async.md) to understand which to choose. Below are important anti-patterns for both aysnc and sync activities.
...
See [references/python/error-handling.md](error-handling.md) to understand how to classify errors.
...
It is important to make sure workflows work as expected under failure paths in addition to happy paths. Please see [references/python/testing.md](testing.md) for more info.

### Not Testing Replay

Replay tests help you test that you do not have hidden sources of non-determinism bugs in your workflow code, and should be considered in addition to standard testing. Please see [references/python/testing.md](testing.md) for more info.
