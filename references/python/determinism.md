...
Use the `Replayer` class to verify your code changes are compatible with existing histories. See the Workflow Replay Testing section of [references/python/testing.md](testing.md).
...
See more info at [references/python/determinism-protection.md](determinism-protection.md)
