...
See [references/typescript/determinism-protection.md](determinism-protection.md) for more information about the sandbox.
...
Use `Worker.runReplayHistory()` to verify your code changes are compatible with existing histories. See the Workflow Replay Testing section of [references/typescript/testing.md](testing.md).
