...
- **`references/typescript/worker-connections.md`** - `NativeConnection` lifecycle: create, pass to `Worker.create()`, close on shutdown; configuration sources and Cloud connection options
