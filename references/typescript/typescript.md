...
- **references/typescript/transport-compression.md** - gRPC transport compression defaults and opt-out; core overview at references/core/transport-compression.md
