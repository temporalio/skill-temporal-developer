...
For observability beyond OpenTelemetry tracing (metrics, runtime logger, sinks) read [references/typescript/observability.md](../observability.md).
...
- SDK metrics / observability reference: [references/typescript/observability.md](../observability.md)
