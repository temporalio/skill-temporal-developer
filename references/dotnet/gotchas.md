...
.NET-specific mistakes and anti-patterns. See also [Common Gotchas](../core/gotchas.md) for language-agnostic concepts.
...
See [references/dotnet/determinism-protection.md](determinism-protection.md) for the complete list.

## Wrong Retry Classification

**Example:** Transient network errors should be retried. Authentication errors should not be.
See [references/dotnet/error-handling.md](error-handling.md) to understand how to classify errors.
...
It is important to make sure workflows work as expected under failure paths in addition to happy paths. Please see [references/dotnet/testing.md](testing.md) for more info.

### Not Testing Replay

Replay tests help you test that you do not have hidden sources of non-determinism bugs in your workflow code. Please see [references/dotnet/testing.md](testing.md) for more info.
