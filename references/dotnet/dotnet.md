...
**CRITICAL**: The .NET SDK has **no sandbox**. Developers must be careful to avoid non-deterministic code in workflows. See the Determinism Rules section below and [references/dotnet/determinism.md](determinism.md).

## Understanding Replay

Temporal workflows are durable through history replay. For details on how this works, see [references/core/determinism.md](../core/determinism.md).
...
**Workflow code must be deterministic!** The .NET SDK has no sandbox. See the Determinism Rules section below and [references/core/determinism.md](../core/determinism.md) and [references/dotnet/determinism.md](determinism.md).
...
See [references/dotnet/determinism.md](determinism.md) for the full list of forbidden operations, safe alternatives, and best practices. See [references/dotnet/determinism-protection.md](determinism-protection.md) for details on the runtime detection mechanism.
...
See [references/dotnet/testing.md](testing.md) for info on writing tests.

## Additional Resources

### Reference Files

- **[references/dotnet/patterns.md](patterns.md)** — Signals, queries, child workflows, saga pattern, etc.
- **[references/dotnet/determinism.md](determinism.md)** — Essentials of determinism in .NET
- **[references/dotnet/gotchas.md](gotchas.md)** — .NET-specific mistakes and anti-patterns
- **[references/dotnet/error-handling.md](error-handling.md)** — ApplicationFailureException, retry policies, non-retryable errors
- **[references/dotnet/observability.md](observability.md)** — Logging, metrics, tracing
- **[references/dotnet/testing.md](testing.md)** — WorkflowEnvironment, time-skipping, activity mocking
- **[references/dotnet/advanced-features.md](advanced-features.md)** — Schedules, worker tuning, dependency injection
- **[references/dotnet/data-handling.md](data-handling.md)** — Data converters, payload encryption, etc.
- **[references/dotnet/versioning.md](versioning.md)** — Patching API, workflow type versioning, Worker Versioning
- **[references/dotnet/standalone-activities.md](standalone-activities.md)** — Standalone Activities: run an Activity directly from a Client without a Workflow. Concept overview at [references/core/standalone-activities.md](../core/standalone-activities.md).
- **[references/dotnet/priority-fairness.md](priority-fairness.md)** — Task Queue Priority and Fairness SDK options and examples. Concept overview at [references/core/priority-fairness.md](../core/priority-fairness.md).
- **[references/dotnet/determinism-protection.md](determinism-protection.md)** — Runtime task detection, .NET Task determinism rules
