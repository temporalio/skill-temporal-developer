...
- **`references/java/spring-ai.md`** - Spring AI integration (`temporal-spring-ai`): durable Spring AI agents, `ActivityChatModel` / `TemporalChatClient`, tool dispatch (Activity stubs, Nexus stubs, `@SideEffectTool`, plain tools), vector stores, embeddings, MCP
