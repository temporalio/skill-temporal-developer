...
To allow other exception types to fail the workflow instead of causing infinite task retries, see [references/java/advanced-features.md](advanced-features.md) for configuring `setFailWorkflowExceptionTypes()`.
...
6. Design code to be idempotent for safe retries (see more at [references/core/patterns.md](../core/patterns.md))
