...
Go-specific mistakes and anti-patterns. See also [Common Gotchas](../core/gotchas.md) for language-agnostic concepts.
...
See [references/go/error-handling.md](error-handling.md) for detailed guidance on error classification and retry policies.
...
It is important to make sure workflows work as expected under failure paths in addition to happy paths. Please see [references/go/testing.md](testing.md) for more info.

### Not Testing Replay

Replay tests help you test that you do not have hidden sources of non-determinism bugs in your workflow code, and should be considered in addition to standard testing. Please see [references/go/testing.md](testing.md) for more info.
