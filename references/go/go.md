...
- **`references/go/resource-tuning.md`** - Resource-based slot suppliers and composite Worker tuners (`worker.NewResourceBasedTuner`, `worker.NewCompositeTuner`) plus the `contrib/sysinfo` host-info package
