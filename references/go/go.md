...
- **`references/go/resource-tuning.md`** - Resource-based and composite worker tuners (`worker.NewResourceBasedTuner`, `worker.NewCompositeTuner`) and the `sysinfo` contrib package for host CPU/memory
