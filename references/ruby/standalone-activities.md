...
Standalone Activities are conceptually the same across all SDKs. Read the [cross-SDK concept file](../core/standalone-activities.md) if you have not already, and then see below for the Ruby SDK specific APIs for calling Standalone Activities.
