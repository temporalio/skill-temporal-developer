...
- **`references/python/langsmith-tracing.md`** *(Python only)* - Experimental `LangSmithPlugin` from `temporalio.contrib.langsmith` for tracing `@traceable` calls inside Workflows and Activities
