...
- **`references/core/nexus.md`** - Temporal Nexus concepts: cross-Namespace Services, Operations (sync vs. async), Endpoints, Registry, lifecycle, timeouts, retries, circuit breaking, cancellation vs. termination, patterns, security, observability
