...
- **`references/core/activity-operations.md`** - Activity Operator Commands for Activities: Pause, Unpause, and Update Options (including restore-original-options semantics)
  - Language-specific info at `references/{your_language}/activity-operations.md`
