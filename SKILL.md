...
- **`references/core/patch-activation-callback.md`** - Control whether the first non-replay `patched()` call activates during rolling deployments
  - Language-specific info at `references/{your_language}/patch-activation-callback.md`
